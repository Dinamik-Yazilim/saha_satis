    ...
    await txn.execute(
      DatabaseHelper.createTableSql(
        'STOKLAR', // The table name in Sqflite.
        {
          ...
          'unit1Multiplier': int, // Corresponds to sto_birim1_katsayi AS unit1Multiplier
          'unit2Name': String, // Corresponds to sto_birim2_ad AS unit2Name
          'unit2Multiplier': int, // Corresponds to sto_birim2_katsayi AS unit2Multiplier
          'unit3Name': String, // Corresponds to sto_birim3_ad AS unit3Name
          'unit3Multiplier': int, // Corresponds to sto_birim3_katsayi AS unit3Multiplier
          'unit4Name': String, // Corresponds to sto_birim4_ad AS unit4Name
          'unit4Multiplier': int, // Corresponds to sto_birim4_katsayi AS unit4Multiplier
          ...
          'createdBy': String, // Corresponds to sto_create_user AS createdBy
          'createdAt': String, // Corresponds to sto_create_date AS createdAt
          'updatedBy': String, // Corresponds to sto_lastup_user AS updatedBy
